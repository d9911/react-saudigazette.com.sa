import { getImageUrl, ESPORTS_ARTICLES } from '../data'
export default function Esports() {
  return (
    <div className="mb-8" id="esports">
      <h3 className="big-title text-[28px] font-serif font-bold text-[#335243] border-b border-gray-300 pb-1.5 mb-2 dark:text-emerald-400">Esports Nations</h3>
