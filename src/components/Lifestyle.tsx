import { getImageUrl, LIFESTYLE_ARTICLES } from '../data'
export default function Lifestyle() {
  return (
    <div className="mb-8" id="life">
      <h3 className="big-title text-[28px] font-serif font-bold text-[#335243] border-b border-gray-300 pb-1.5 mb-2 dark:text-emerald-400">Lifestyle & Arts</h3>
